...
java -jar %UPLOADER_PATH%\EspHtmlPackager.jar -name "%PROJECT_NAME%" -source "%PROJECT_SOURCE%" -target "%PROJECT_TARGET%" -comp1 "%COMMON_COMP%" -comp2 "%PROJECT_COMP%" -ip "%IP%" -upload "True" -deleteHtml "False"