...
public:
	...
	void initSensor(){
		...
		items[0]={0,FPSTR(TEMPERATURE_DHT22),FPSTR(MEASURE_CELSIUS_DEGREES),FPSTR(MEASURE_CELSIUS_DEGREES_RU),FPSTR(TEMPERATURE_RU),-256,0,-512,512};
		items[1]={1,FPSTR(HUMIDITY_DHT22),FPSTR(MEASURE_PERSENT),FPSTR(MEASURE_PERSENT_RU),FPSTR(HUMIDITY_RU),-256,0,-512,512};
	}
